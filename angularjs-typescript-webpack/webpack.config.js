...
module.exports = (env, argv) => {
  ...
  let featurefilenameSearchPattern = "index.js";
  let ngJSfilenameSearchPattern = "main.ts";
  ...
  let entryModules = {
    // ...entries(featurefilenameSearchPattern),
    ...entries(ngJSfilenameSearchPattern)
  };

  console.log("entryModules", entryModules);
  for (let b in entryModules) {
    console.log(b);
  }


  const htmlPlugins = [];
  for (let pathKey in entryModules) {
    htmlPlugins.push(new HtmlWebPackPlugin({
      filename: `${distPath}/${pathKey}/index.html`,
      template: `${sourcePath}/${pathKey}/index.html`
    }));
  }
